        ...
        <div class="card text-white bg-secondary mb-3" style="max-width: 40rem;">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" pattern="^(?!.* (?: |$))[A-ZÁÉÍÓÚ][A-Za-záéíóúÁÉÍÓÚ1-9,\u00f1\u00d1 ]+([.])?$" title="Debe poner solo palabras con la primera letra en Mayuscula" required>
                    @error('descripcion')

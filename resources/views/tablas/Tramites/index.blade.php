...
<div class="container-fluid">
    <h3 style="position:relative; opacity: 1 !important;">GESTIÓN DE TRÁMITES</h3>
    <div class="card">
        ...
        <div class="card-body table-responsive">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th>Título</th>
                <th style="max-width: 15vw">Descripción</th>
                <th style="max-width: 15vw">Archivo</th>
                <th>Opciones</th>
              </tr>
              </thead>
              <tbody>
              ...
              @foreach($tramite as $item) 
                <tr>
                    <td style="text-align: center">{{$item->idTramite}}</td>

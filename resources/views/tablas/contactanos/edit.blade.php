        ...
        <div class="card text-white bg-secondary mb-3" style="max-width: 40rem;">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control @error('correo') is-invalid @enderror" id="correo" name="correo" required value="{{$contactanos->correo}}" title="correo@unitru.edu.pe">
                    @error('correo')
                    ...
                    <input type="tel" class="form-control" name="telefono" id="telefono" pattern="[0-9]{3}-[0-9]{6}" required value="{{$contactanos->telefono}}" title="XXX-XXXXXX">
